...
const page = () => {
  return (
    ...
    sticky top-0 h-screen p-6 ">
      <div>
        ...
        <nav className="flex flex-col gap-1">
          <Link href={"/caregiver"} className="bg-white/5 rounded-lg"><SidebarItem icon={FiHome} label="Home" /></Link>
          <Link href={"/caregiver/logTracker"}><SidebarItem icon={FiBookOpen} label="Log Tracker" /></Link>
    ...
    <Header/>
    {/* greeting and patient stats */}
    <h1 className='text-xl text-gray-950'>Good Morning, 
        <span className='font-bold text-orange-500'>Dr Kim!</span></h1>
    {/* stats */}
    <div className='bg-green-950 rounded-lg max-w-lg pl-5 pt-3'>
        <div className='text-gray-50 text-sm '>Visits for today</div>
        <div className='text-gray-50 text-4xl '>104</div>
