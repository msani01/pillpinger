    ...
    sticky top-0 h-screen p-6 ">
      <div>
        ...
        <nav className="flex flex-col gap-1">
          <Link href={"/client"} className="bg-white/5 rounded-lg"><SidebarItem icon={FiHome} label="Home" /></Link>
          <Link href={"/client/logTracker"}><SidebarItem icon={FiBookOpen} label="Log Tracker" /></Link>
